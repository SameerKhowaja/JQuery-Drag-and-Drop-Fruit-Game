...
function setWindowLoad() {
    person = prompt("Please enter your name to save scores", "Sameer Khowaja");
    //document.getElementById("nam").innerHTML = person;
    document.getElementById("timer").innerHTML = timer;
}
...
window.setInterval(function() {
    ...
    if (time > 0) {
        ...
        if (isplayed == false) {
            ...
            document.getElementById("outAudio").pause();
        }
...
$(document).ready(function() {
    $("#Save_Scores").click(function(event) {
        var name = person;
        $("#stage").load('savedata.php', { "name": name, "lvl": level, "scr": score });
        $('#Save_Scores').hide();
    });
});

$(document).ready(function() {
    $("#See_Scores").click(function(event) {
        $("#stage").load('loaddata.php', { "name": "Loading Data..." });
    });
});
